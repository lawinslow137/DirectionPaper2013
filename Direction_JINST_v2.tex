...
\begin{figure}[tbh]
        ...
        \subfigure{\includegraphics[scale=0.375]{graphs/hDir_34ns.pdf}}
        \subfigure{\includegraphics[scale=0.375]{graphs/hVtx_34ns.pdf}}
...
\begin{figure}[tbh]
        ...
        %%\subfigure{\includegraphics[scale=0.295]{graphs/hVtxY_v1.pdf}}
        %%\subfigure{\includegraphics[scale=0.295]{graphs/hVtxZ_v1.pdf}}
        \subfigure{\includegraphics[scale=0.375]{graphs/hDir_pq_1p4.pdf}}
        \subfigure{\includegraphics[scale=0.375]{graphs/hVtx_pq_1p4.pdf}}
...
\begin{figure}
        ...
        \caption[]{Mean cosine of the angle between the true initial electron direction and the reconstructed direction, depending on the energy of the initial electrons. For each energy 1000 events have been simulated. Statistical errors are
