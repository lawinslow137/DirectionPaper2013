...
\pacs{23.40.$-$s, 14.60.Pq, 13.15.+g, 29.40.Mc}
...
\begin{figure}
        \begin{center}
        \includegraphics[scale=0.4]{geometry_plot_labels.pdf}
...
\begin{center}
        \subfigure[ ~Default
        simulation.]{\includegraphics[scale=0.295]{6p5Meter_5MeVElectrons_Bialkali_KamlandScintSpec_TIME.pdf}}
        \subfigure[ ~Increased TTS
        (1.28~ns).]{\includegraphics[scale=0.295]{6p5Meter_5MeVElectrons_Bialkali_KamlandScintSpec_1p28nsTTS_TIME.pdf}}
        \subfigure[ ~Red-sensitive
        photocathode.]{\includegraphics[scale=0.295]{6p5Meter_5MeVElectrons_RedSensitiveQE_KamlandScintSpec_TIME.pdf}}
...
system. First, the simulated travel time of the initial 5~MeV electron is between
...
on the idea for increasing discrimination between Cherenkov and
...
\begin{figure}
        \begin{center}
        \includegraphics[scale=0.40]{cos_psi_34_h.pdf}
...
ratio ($R_{C/S}=1.6$) in the early time window would significantly improve the
...
\begin{figure*}[tbh]
        \begin{center}
        \subfigure{\includegraphics[scale=0.4]{hDir_34ns.pdf}}
        \subfigure{\includegraphics[scale=0.4]{hVtx_34ns.pdf}}
...
the x-axis, $\frac{\vec{p}}{|\vec{p}|}$ = (1,0,0). Figure~\ref{fig:reco}
