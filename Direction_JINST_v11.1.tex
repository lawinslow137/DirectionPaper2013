...
into an effective Cherenkov threshold for electrons at 0.188~MeV. For a 5~MeV electron, this yields 685 Cherenkov photons per event when integrating from the cutoff wavelength at 370~nm to 550~nm,  the wavelength above which a small number of photons is detected due to the quantum efficiency of a standard bialkali photocathode. Lowering the energy to 1~MeV yields 82 Cherenkov photons between 370-550~nm.
...
and 108 (171) for electron energies of 1.4~MeV, 2.1~MeV and 5~MeV, respectively. This gives the
