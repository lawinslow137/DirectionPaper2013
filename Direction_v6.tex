...
\begin{figure}
        ...
        The radial rays (green lines) are photons emitted by two back-to-back electrons with 1.41~MeV each
...
\begin{figure*}[tbh]
        ...
        \subfigure{\includegraphics[scale=0.4]{graphs/hDir_34ns.pdf}}
        \subfigure{\includegraphics[scale=0.4]{graphs/hVtx_34ns.pdf}}
...
34.0~ns, the ratio $R_{C/S}$ is high, improving the event selection. In this section, we apply
...
event: the wavelength and hence the speed of the light in the medium,
